...
public abstract class AbstractTagoBusAPIService {
    ...
    protected AbstractTagoBusAPIService(
            String apiKey,
            String endpoint,
            String path,
    ...
    protected Mono<IResponse> getDataFromOpenAPI(MultiValueMap<String, String> queryParams) {
                ...
                return response
                        ...
                        .flatMap(body -> {
                            try {
                                ...
                                IResponse result = (IResponse) unmarshaller.unmarshal(reader);
