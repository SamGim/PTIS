...
@Slf4j
@Component
@Qualifier("B0006FailureHandlingTasklet")
@StepScope
public class B0006FailureHandlingTasklet extends AbstractFailureHandlingTasklet {
    private StepExecution stepExecution;
    public B0006FailureHandlingTasklet(
