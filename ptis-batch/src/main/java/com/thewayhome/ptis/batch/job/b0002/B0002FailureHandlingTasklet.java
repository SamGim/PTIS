...
@Slf4j
@Component
@Qualifier("B0002FailureHandlingTasklet")
@StepScope
public class B0002FailureHandlingTasklet extends AbstractFailureHandlingTasklet {
    private StepExecution stepExecution;
    public B0002FailureHandlingTasklet(
