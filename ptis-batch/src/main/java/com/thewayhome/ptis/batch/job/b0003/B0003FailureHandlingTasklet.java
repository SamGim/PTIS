...
@Slf4j
@Component
@Qualifier("B0003FailureHandlingTasklet")
@StepScope
public class B0003FailureHandlingTasklet extends AbstractFailureHandlingTasklet {
    private StepExecution stepExecution;
    public B0003FailureHandlingTasklet(
