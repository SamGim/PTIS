...
@StepScope
public class B0004DoMainLogicItemReader implements ItemStreamReader<B0004DoMainLogicItemInput> {
    ...
    public B0004DoMainLogicItemInput read() {
        ...
        String nodeType = (String) item.get("uptaenm");

        return B0004DoMainLogicItemInput
                .builder()
                .nodeId(nodeId)
