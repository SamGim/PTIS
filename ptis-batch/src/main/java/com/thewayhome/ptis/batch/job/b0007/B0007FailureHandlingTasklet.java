...
@Slf4j
@Component
@Qualifier("B0007FailureHandlingTasklet")
@StepScope
public class B0007FailureHandlingTasklet extends AbstractFailureHandlingTasklet {
    private StepExecution stepExecution;
    public B0007FailureHandlingTasklet(
