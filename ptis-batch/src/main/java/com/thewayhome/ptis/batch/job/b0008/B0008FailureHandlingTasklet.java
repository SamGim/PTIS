...
@Slf4j
@Component
@Qualifier("B0008FailureHandlingTasklet")
@StepScope
public class B0008FailureHandlingTasklet extends AbstractFailureHandlingTasklet {
    private StepExecution stepExecution;
    public B0008FailureHandlingTasklet(
