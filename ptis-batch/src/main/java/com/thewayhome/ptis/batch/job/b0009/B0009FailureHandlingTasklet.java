...
@Slf4j
@Component
@Qualifier("B0009FailureHandlingTasklet")
@StepScope
public class B0009FailureHandlingTasklet extends AbstractFailureHandlingTasklet {
    private StepExecution stepExecution;
    public B0009FailureHandlingTasklet(
