...
@Slf4j
@Component
@Qualifier("B0010FailureHandlingTasklet")
@StepScope
public class B0010FailureHandlingTasklet extends AbstractFailureHandlingTasklet {
    private StepExecution stepExecution;
    public B0010FailureHandlingTasklet(
