...
@Slf4j
@Component
@Qualifier("B0014FailureHandlingTasklet")
@StepScope
public class B0014FailureHandlingTasklet extends AbstractFailureHandlingTasklet {
    private StepExecution stepExecution;
    public B0014FailureHandlingTasklet(
