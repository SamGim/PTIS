...
@Slf4j
@Component
@Qualifier("B0020FailureHandlingTasklet")
@StepScope
public class B0020FailureHandlingTasklet extends AbstractFailureHandlingTasklet {
    private StepExecution stepExecution;
    public B0020FailureHandlingTasklet(
