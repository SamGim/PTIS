...
@Slf4j
@Component
@Qualifier("B0021FailureHandlingTasklet")
@StepScope
public class B0021FailureHandlingTasklet extends AbstractFailureHandlingTasklet {
    private StepExecution stepExecution;
    public B0021FailureHandlingTasklet(
